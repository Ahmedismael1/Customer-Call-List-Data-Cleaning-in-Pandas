...
[Uploading Customer Call List Data Cleaning {
 "cells": [
  {
   "cell_type": "code",
   "execution_count": 1,
  ...
  },
  {
   ...
   "outputs": [],
   "source": [
    "df=pd.read_excel(r'D:\\my summary\\Data set\\Customer Call List.xlsx')"
   ]
  },
  {
   "cell_type": "code",
  ...
  },
  {
   ...
   "outputs": [],
   "source": [
    "## Strip the name from the unknown variable \n",
  ...
  },
  {
   ...
   "source": [
    "## Replace any thing in phone number like (-,/,|,....)\n",
  ...
  },
  {
   ...
   "source": [
    ...
    "        df.drop(x,inplace = True)\n",
    "\n",
    "## Another way to drop the null value\n",
